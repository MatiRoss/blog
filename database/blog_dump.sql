...
INSERT INTO `authors` (`idauthors`, `name`, `forename`, `nickname`) VALUES
(1,	'Dupont',	'',	'Matéo'),
(2,	'Mimi',	'',	'Valentine'),
(3,	'Zouzou',	'Michel',	'Michou'),
(7,	'Ping',	'Bernard',	'bernard_du_26'),
(8,	'Delpeche',	NULL,	'Beber');
...
CREATE TABLE `categories_has_posts` (
  ...
  PRIMARY KEY (`categories_idcategories`,`posts_idposts`),
  KEY `fk_categories_has_posts_posts1_idx` (`posts_idposts`),
  KEY `fk_categories_has_posts_categories1_idx` (`categories_idcategories`),
  CONSTRAINT `fk_categories_has_posts_categories1` FOREIGN KEY (`categories_idcategories`) REFERENCES `categories` (`idcategories`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_categories_has_posts_posts1` FOREIGN KEY (`posts_idposts`) REFERENCES `posts` (`idposts`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `comments` (
  ...
  KEY `fk_comments_authors1_idx` (`authors_idauthors`),
  KEY `fk_comments_posts1_idx` (`posts_idposts`),
  CONSTRAINT `fk_comments_authors1` FOREIGN KEY (`authors_idauthors`) REFERENCES `authors` (`idauthors`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_comments_posts1` FOREIGN KEY (`posts_idposts`) REFERENCES `posts` (`idposts`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO `comments` (`idcomments`, `text`, `date_com`, `authors_idauthors`, `posts_idposts`) VALUES
(1,	'Bravo!',	'2021-01-21 13:18:48',	8,	1),
(2,	'Je commente mon propre article',	'2021-01-21 13:23:38',	1,	1),
(4,	'Sans avis',	'2021-01-21 13:26:19',	2,	3),
(5,	'Sans avis',	'2021-01-21 13:26:47',	3,	2);
...
CREATE TABLE `posts` (
  ...
  `authors_idauthors` int(11) NOT NULL,
  PRIMARY KEY (`idposts`),
  KEY `fk_posts_authors1_idx` (`authors_idauthors`),
  CONSTRAINT `fk_posts_authors1` FOREIGN KEY (`authors_idauthors`) REFERENCES `authors` (`idauthors`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO `posts` (`idposts`, `title`, `text`, `date_start`, `date_end`, `importance`, `authors_idauthors`) VALUES
(1,	'Le sport, c\'est bien.',	'Le biathlon c\'est l\'avenir.',	'2021-01-21 13:16:39',	'2021-01-30 13:15:03',	0,	1),
(2,	'Php, le retour',	'Blablablablalbalbabla',	'2021-01-21 13:20:11',	'2021-01-29 13:19:09',	3,	3),
(3,	'L\'universalité en 14 points',	'LOREMMMM IPSUMMMM',	'2021-01-21 13:22:44',	'2021-01-28 13:21:45',	2,	2);
...
('blog',	'authors',	'PRIMARY',	'2021-01-25 09:39:08',	'n_diff_pfx01',	5,	1,	'idauthors'),
('blog',	'authors',	'PRIMARY',	'2021-01-25 09:39:08',	'n_leaf_pages',	1,	NULL,	'Number of leaf pages in the index'),
('blog',	'authors',	'PRIMARY',	'2021-01-25 09:39:08',	'size',	1,	NULL,	'Number of pages in the index'),
('blog',	'authors',	'nickname_UNIQUE',	'2021-01-25 09:39:08',	'n_diff_pfx01',	5,	1,	'nickname'),
('blog',	'authors',	'nickname_UNIQUE',	'2021-01-25 09:39:08',	'n_leaf_pages',	1,	NULL,	'Number of leaf pages in the index'),
('blog',	'authors',	'nickname_UNIQUE',	'2021-01-25 09:39:08',	'size',	1,	NULL,	'Number of pages in the index'),
('blog',	'categories',	'PRIMARY',	'2021-01-25 09:39:08',	'n_diff_pfx01',	0,	1,	'idcategories'),
('blog',	'categories',	'PRIMARY',	'2021-01-25 09:39:08',	'n_leaf_pages',	1,	NULL,	'Number of leaf pages in the index'),
('blog',	'categories',	'PRIMARY',	'2021-01-25 09:39:08',	'size',	1,	NULL,	'Number of pages in the index'),
('blog',	'categories_has_posts',	'PRIMARY',	'2021-01-25 09:39:08',	'n_diff_pfx01',	0,	1,	'categories_idcategories'),
('blog',	'categories_has_posts',	'PRIMARY',	'2021-01-25 09:39:08',	'n_diff_pfx02',	0,	1,	'categories_idcategories,posts_idposts'),
('blog',	'categories_has_posts',	'PRIMARY',	'2021-01-25 09:39:08',	'n_leaf_pages',	1,	NULL,	'Number of leaf pages in the index'),
('blog',	'categories_has_posts',	'PRIMARY',	'2021-01-25 09:39:08',	'size',	1,	NULL,	'Number of pages in the index'),
('blog',	'categories_has_posts',	'fk_categories_has_posts_categories1_idx',	'2021-01-25 09:39:08',	'n_diff_pfx01',	0,	1,	'categories_idcategories'),
('blog',	'categories_has_posts',	'fk_categories_has_posts_categories1_idx',	'2021-01-25 09:39:08',	'n_diff_pfx02',	0,	1,	'categories_idcategories,posts_idposts'),
('blog',	'categories_has_posts',	'fk_categories_has_posts_categories1_idx',	'2021-01-25 09:39:08',	'n_leaf_pages',	1,	NULL,	'Number of leaf pages in the index'),
('blog',	'categories_has_posts',	'fk_categories_has_posts_categories1_idx',	'2021-01-25 09:39:08',	'size',	1,	NULL,	'Number of pages in the index'),
('blog',	'categories_has_posts',	'fk_categories_has_posts_posts1_idx',	'2021-01-25 09:39:08',	'n_diff_pfx01',	0,	1,	'posts_idposts'),
('blog',	'categories_has_posts',	'fk_categories_has_posts_posts1_idx',	'2021-01-25 09:39:08',	'n_diff_pfx02',	0,	1,	'posts_idposts,categories_idcategories'),
('blog',	'categories_has_posts',	'fk_categories_has_posts_posts1_idx',	'2021-01-25 09:39:08',	'n_leaf_pages',	1,	NULL,	'Number of leaf pages in the index'),
('blog',	'categories_has_posts',	'fk_categories_has_posts_posts1_idx',	'2021-01-25 09:39:08',	'size',	1,	NULL,	'Number of pages in the index'),
('blog',	'comments',	'PRIMARY',	'2021-01-25 09:39:08',	'n_diff_pfx01',	4,	1,	'idcomments'),
('blog',	'comments',	'PRIMARY',	'2021-01-25 09:39:08',	'n_leaf_pages',	1,	NULL,	'Number of leaf pages in the index'),
('blog',	'comments',	'PRIMARY',	'2021-01-25 09:39:08',	'size',	1,	NULL,	'Number of pages in the index'),
('blog',	'comments',	'fk_comments_authors1_idx',	'2021-01-25 09:39:08',	'n_diff_pfx01',	4,	1,	'authors_idauthors'),
('blog',	'comments',	'fk_comments_authors1_idx',	'2021-01-25 09:39:08',	'n_diff_pfx02',	4,	1,	'authors_idauthors,idcomments'),
('blog',	'comments',	'fk_comments_authors1_idx',	'2021-01-25 09:39:08',	'n_leaf_pages',	1,	NULL,	'Number of leaf pages in the index'),
('blog',	'comments',	'fk_comments_authors1_idx',	'2021-01-25 09:39:08',	'size',	1,	NULL,	'Number of pages in the index'),
('blog',	'comments',	'fk_comments_posts1_idx',	'2021-01-25 09:39:08',	'n_diff_pfx01',	3,	1,	'posts_idposts'),
('blog',	'comments',	'fk_comments_posts1_idx',	'2021-01-25 09:39:08',	'n_diff_pfx02',	4,	1,	'posts_idposts,idcomments'),
('blog',	'comments',	'fk_comments_posts1_idx',	'2021-01-25 09:39:08',	'n_leaf_pages',	1,	NULL,	'Number of leaf pages in the index'),
('blog',	'comments',	'fk_comments_posts1_idx',	'2021-01-25 09:39:08',	'size',	1,	NULL,	'Number of pages in the index'),
('blog',	'posts',	'PRIMARY',	'2021-01-25 09:39:08',	'n_diff_pfx01',	3,	1,	'idposts'),
('blog',	'posts',	'PRIMARY',	'2021-01-25 09:39:08',	'n_leaf_pages',	1,	NULL,	'Number of leaf pages in the index'),
('blog',	'posts',	'PRIMARY',	'2021-01-25 09:39:08',	'size',	1,	NULL,	'Number of pages in the index'),
('blog',	'posts',	'fk_posts_authors1_idx',	'2021-01-25 09:39:08',	'n_diff_pfx01',	3,	1,	'authors_idauthors'),
('blog',	'posts',	'fk_posts_authors1_idx',	'2021-01-25 09:39:08',	'n_diff_pfx02',	3,	1,	'authors_idauthors,idposts'),
('blog',	'posts',	'fk_posts_authors1_idx',	'2021-01-25 09:39:08',	'n_leaf_pages',	1,	NULL,	'Number of leaf pages in the index'),
('blog',	'posts',	'fk_posts_authors1_idx',	'2021-01-25 09:39:08',	'size',	1,	NULL,	'Number of pages in the index'),
('mysql',	'gtid_slave_pos',	'PRIMARY',	'2021-01-22 13:26:10',	'n_diff_pfx01',	0,	1,	'domain_id'),
('mysql',	'gtid_slave_pos',	'PRIMARY',	'2021-01-22 13:26:10',	'n_diff_pfx02',	0,	1,	'domain_id,sub_id'),
('mysql',	'gtid_slave_pos',	'PRIMARY',	'2021-01-22 13:26:10',	'n_leaf_pages',	1,	NULL,	'Number of leaf pages in the index'),
('mysql',	'gtid_slave_pos',	'PRIMARY',	'2021-01-22 13:26:10',	'size',	1,	NULL,	'Number of pages in the index');
...
('blog',	'authors',	'2021-01-25 09:39:08',	5,	1,	1),
('blog',	'categories',	'2021-01-25 09:39:08',	0,	1,	0),
('blog',	'categories_has_posts',	'2021-01-25 09:39:08',	0,	1,	2),
('blog',	'comments',	'2021-01-25 09:39:08',	4,	1,	2),
('blog',	'posts',	'2021-01-25 09:39:08',	3,	1,	1),
('mysql',	'gtid_slave_pos',	'2021-01-22 13:26:10',	0,	1,	0);
...
('localhost',	'root',	'',	'',	1,	'',	'2021-01-22 13:26:10');
...
('localhost',	'root',	'*54958E764CE10E50764C2EECBB71D01F08549980',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'',	'',	'',	'',	0,	0,	0,	0,	'unix_socket',	'',	'N',	'N',	'',	0.000000),
('localhost',	'mati',	'*54958E764CE10E50764C2EECBB71D01F08549980',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'N',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'Y',	'',	'',	'',	'',	0,	0,	0,	0,	'',	'',	'N',	'N',	'',	0.000000);
